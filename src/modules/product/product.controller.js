...
const list = asyncHandler(async (req, res) => {
  ...
  const result = await productService.listProducts({
    ...
    product_type_id: productTypeId != null && productTypeId !== "" ? parseInt(productTypeId, 10) : null,
    product_make_name: productMakeName,
    product_make_id: productMakeId != null && productMakeId !== "" ? parseInt(productMakeId, 10) : null,
